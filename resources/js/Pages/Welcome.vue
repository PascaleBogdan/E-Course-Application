...
<template>
    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl_ mx-auto p-6 lg:p-8 flex flex-col h-full justify-center text-center">
            <div class="text-7xl font-black">
                WELCOME TO <span class="p-4 bg-amber-400 bg-opacity-50 animate-pulse">COURSES UNHINGED</span>
            </div>
            <div class="pt-14 text-3xl">
                All what you can study!
            </div>
        </div>
    </div>
</template>
